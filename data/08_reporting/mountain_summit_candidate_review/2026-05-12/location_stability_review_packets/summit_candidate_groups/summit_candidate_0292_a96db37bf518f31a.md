# Summit Candidate Conflict Packet (Location-Stability Refined): summit_candidate_0292
...
|---|---|---|---|---|---|---|---|
| 497 | 面木山 | 2 | 0.5 | 93.5 | `location_uncertain_keep` | **low** | false |
| 498 | 黒森 | 1 | 0.68 | 8.5 | `location_uncertain_keep` | **medium** | true |
