...
| `data/01_raw/provider_received/yoshitomi/2026-05-12/GPXファイル.zip` | `.zip` | Primary Source | Manual/Original | Intake Skill | `data/01_raw/source_archives/` | preserved as raw snapshot | Pending | High | No | Original export package for GPX files. Moved into `processed/` as old workflow processed-marker state after intake. |
