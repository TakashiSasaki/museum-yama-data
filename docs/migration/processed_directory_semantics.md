...
- **`retained_source_snapshot`**: An original source workbook, original ZIP export package, or other original input archive (e.g., `data/01_raw/provider_received/yoshitomi/2026-05-12/GPXファイル.zip`, `data/01_raw/provider_received/yoshitomi/2026-05-18/えひめの山.xlsx`).
