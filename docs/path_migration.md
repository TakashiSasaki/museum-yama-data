...
| `data/01_raw/provider_received/yoshitomi/1980-01-01/えひめの山.xlsx` | `data/01_raw/source_archives/` | Source Archive | No (Not yet performed) | | None | Primary activity log workbook. Git-primary retained source snapshot; legacy processed-marker archive location. Source for the four-sheet CSV extraction. Will be a DVC dependency candidate. |
| `data/01_raw/provider_received/yoshitomi/2026-05-12/GPXファイル.zip` | `data/01_raw/source_archives/` | Source Archive | No (Not yet performed) | | None | Primary GPX export package. Git-primary retained source snapshot; legacy processed-marker archive location. Will be a DVC dependency candidate. |
