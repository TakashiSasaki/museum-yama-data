...
| data/08_reporting/mountain_summit_candidate_review/.../compact_review_queue_* | Compact review queue files (CSV/Markdown/JSON) | resolved | Compacted review queues | same | Historical/superseded. These artifacts were generated by an older review workflow and were later deleted as obsolete before active review. | No | Yes | None | Generated by generate-compact-mountain-summit-review-queues | N/A | N/A | N/A | resolved | derived_only |
| data/08_reporting/mountain_summit_candidate_review/.../conflict_groups_* | Conflict groups by GPX/Summit (CSV) | resolved | Conflict-focused review groups | same | Historical/superseded. These artifacts were generated by an older review workflow and were later deleted as obsolete before active review. | No | Yes | None | Generated by generate-compact-mountain-summit-review-queues | N/A | N/A | N/A | resolved | derived_only |
| data/08_reporting/mountain_summit_candidate_review/.../review_packets/ | Markdown review packets (GPX traverses and summit conflicts) | resolved | Review packets | same | Historical/superseded. These artifacts were generated by an older review workflow and were later deleted as obsolete before active review. They remain documented for provenance and mapping history only. Current review entry points must be determined from `docs/migration/current_processing_state_audit.md`. | No | Yes | None | Generated by generate-mountain-summit-review-packets | N/A | N/A | N/A | resolved | derived_only |
| data/08_reporting/mountain_summit_candidate_review/.../review_decisions_template.csv | Prefilled human decision template (CSV) | resolved | Human decision template | same | Historical/superseded. These artifacts were generated by an older review workflow and were later deleted as obsolete before active review. They remain documented for provenance and mapping history only. Current review entry points must be determined from `docs/migration/current_processing_state_audit.md`. | No | Yes | None | Generated by generate-mountain-summit-review-packets | N/A | N/A | N/A | resolved | derived_only |
