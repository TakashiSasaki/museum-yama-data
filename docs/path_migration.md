...
| `processed/えひめの山.xlsx` | `data/01_raw/source_archives/` | Source Archive | No (Not yet performed) | | DVC dependency candidate | Primary activity log workbook |
| `processed/GPXファイル.zip` | `data/01_raw/source_archives/` | Source Archive | No (Not yet performed) | | DVC dependency candidate | Primary GPX export package |
| `yamap/*.md` | `data/01_raw/yamap_markdown/` | Source | No (Not yet performed) | Final directory name approval | DVC dependency candidate | Markdown files scraped from YAMAP |
