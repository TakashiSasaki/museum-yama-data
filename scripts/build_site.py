...
def build_decisions():
    ...
    <ul>
        ...
        <li><code>museum-yama-web/mountains.json</code>: Provisional legacy cache. The legacy/manual filename <code>mountains-merged.json</code> is not canonical; the reusable part is the schema/record shape. The future filename and final output path remain undecided.</li>
    ...
    <ul>
        ...
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/provider_received_manifests/README.md" target="_blank" rel="noopener noreferrer">Provider Received Manifests Policy</a>: Defines the structure and usage of human-authored provider manifests.</li>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/provider_received_inventory_report.md" target="_blank" rel="noopener noreferrer">Provider Received Inventory Report</a>: Audit report of the provider-received intake area.</li>
        ...
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/mountain_output_integrity_policy.md" target="_blank" rel="noopener noreferrer">Mountain Output Integrity Policy</a>: Records the 531 mountain output cardinality expectation, discrepancy categories, and provisional row inclusion rule.</li>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/resolved_mountain_json_schema_contract.md" target="_blank" rel="noopener noreferrer">Resolved Mountain JSON Schema Contract</a>: Canonical target schema contract definition.</li>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/mountain_source_validation_report.md" target="_blank" rel="noopener noreferrer">Mountain Source Validation Report</a>: Current state of invariants mapping CSV against JSON artifacts.</li>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/legacy_resolved_mountain_json_schema_audit.md" target="_blank" rel="noopener noreferrer">Legacy Resolved Mountain JSON Schema Audit</a>: Audits legacy artifacts mapping to future output structures.</li>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/dvc_first_stage_plan.md" target="_blank" rel="noopener noreferrer">DVC First-Stage Plan</a>: Outlines the conceptual first stage (<code>detect_summit_candidates_preview</code>) for DVC-light implementation.</li>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/summit_candidate_detection_policy.md" target="_blank" rel="noopener noreferrer">Portable detect-candidates</a>: Establishes <code>detect-candidates</code> as the portable baseline command for summit detection.</li>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/yamap_unresolved_activity_link_resolution.md" target="_blank" rel="noopener noreferrer">Unresolved YAMAP Link Resolution</a>: Confirms that five GPX files are accepted metadata coverage gaps, but remain valid source tracks.</li>
    </ul>
