...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `data/01_raw/provider_received/yoshitomi/2026-05-18/えひめの山.xlsx` | Primary source workbook | preserved_as_raw_snapshot | Raw provider-received file | `data/02_intermediate/activity_logs/csv_extracted/yoshitomi/2026-05-18/*.csv` | Reproducible intermediate output | No | Yes | DVC dependency | Exact extraction of all sheets to CSV via `extract-excel-sheets` | N/A | extract-excel-sheets staged read-back | delete final extracted CSVs | resolved | reproducible_intermediate_output |
