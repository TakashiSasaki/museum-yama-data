...
def build_decisions():
    ...
    <ul>
        ...
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/docs/migration/mountain_output_integrity_policy.md" target="_blank" rel="noopener noreferrer">Mountain Output Integrity Policy</a>: Records the 531 mountain output cardinality invariant and discrepancy categories.</li>
