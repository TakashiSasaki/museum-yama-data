...
| `processed/えひめの山.xlsx` | `data/01_raw/source_archives/` | Source Archive | No (Not yet performed) | | None | Primary activity log workbook. Will be a DVC dependency candidate. |
| `processed/GPXファイル.zip` | `data/01_raw/source_archives/` | Source Archive | No (Not yet performed) | | None | Primary GPX export package. Will be a DVC dependency candidate. |
| `yamap/*.md` | `data/01_raw/yamap_markdown/` | Source | No (Not yet performed) | Final directory name approval | None | Markdown files scraped from YAMAP. Will be a DVC dependency candidate. |
