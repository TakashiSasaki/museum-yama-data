...
def build_decisions():
    ...
    <ul>
        <li><a href="https://github.com/TakashiSasaki/museum-yama-data/blob/HEAD/AGENTS.md" target="_blank" rel="noopener noreferrer">Agent Skill Portability Policy</a>: Defines requirements for reusable pipeline tools and commands.</li>
