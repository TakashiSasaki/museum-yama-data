# Summit Candidate Conflict Packet (Location-Stability Refined): summit_candidate_0261
...
|---|---|---|---|---|---|---|---|
| 117 | 大友山 | 1 | 0.75 | 2.95 | `location_uncertain_keep` | **medium** | true |
| 254 | 平岡山(平岡城址) | 3 | 0.33 | 9.95 | `location_uncertain_keep` | **low** | false |
