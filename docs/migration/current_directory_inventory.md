...
| `gpx/annotated/` | Legacy artifact | retained legacy artifact | Must be preserved | Legacy output | protected; no movement | Source coverage audit, Source-to-target mapping audit | Must not be physically moved yet, nor normalized or regenerated in this task. |
| `gpx/merged-by-year/` | Legacy artifact | retained legacy artifact | Must be preserved | Legacy output | protected; no movement | Source coverage audit, Source-to-target mapping audit | Must not be physically moved yet, nor normalized or regenerated in this task. |
| `csv/` | Legacy Input | retained legacy artifact | Must be preserved | Input | protected; no movement | Source coverage audit, Source-to-target mapping audit | Must not be physically moved yet, nor normalized or regenerated in this task. |
| `processed/` | Source Archive | primary source snapshot | Must be preserved | Archive | protected; no movement | Source coverage audit, Source-to-target mapping audit | Must not be physically moved yet, nor normalized or regenerated in this task. |
...
| `reverse_geocoding/` | Geocoding Cache | retained legacy artifact | Must be preserved | Cache | protected; no movement | Source coverage audit, Source-to-target mapping audit | Must not be physically moved yet, nor normalized or regenerated in this task. |
