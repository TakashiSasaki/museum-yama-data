...
function normalizeDetectionConfig(config) {
    const parseNumberOrDefault = (val, defaultVal, minVal) => {
    ...
    return {
        smoothWindow: parseNumberOrDefault(config.smoothWindow, DEFAULT_SUMMIT_DETECTION_CONFIG.smoothWindow, 1),
        peakRadius: parseNumberOrDefault(config.peakRadius, DEFAULT_SUMMIT_DETECTION_CONFIG.peakRadius, 1),
        minProminence: parseNumberOrDefault(config.minProminence, DEFAULT_SUMMIT_DETECTION_CONFIG.minProminence, 0),
        mergeDistance: parseNumberOrDefault(config.mergeDistance, DEFAULT_SUMMIT_DETECTION_CONFIG.mergeDistance, 0),
    };
}
